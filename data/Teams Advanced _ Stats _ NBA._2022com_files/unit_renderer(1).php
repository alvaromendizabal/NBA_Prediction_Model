var jvx_630166f71b873NonMraidTagInMraidEnv = false;
var jvx_630166f71b873dyPropsACK = false;
...
(function(){
	if(typeof MRAID_ENV != 'undefined'){
		...
		jvx_630166f71b873NonMraidTagInMraidEnv = true;
	}
})();

if(typeof jvxObjectList == "undefined"){
	var jvxObjectList = ["jvx_630166f71b873"];
}else{
	jvxObjectList.push("jvx_630166f71b873");
}
    ...
    try{
        ...
        if(cScrNode == undefined){
            ...
            for(var i=0;i<scrNodes.length;i++){
                ...
                if(scrSrc &&  scrSrc.indexOf("https://as.jivox.com/unit/unit_renderer.php?es_pId=1cdb39e&showAdChoices=1&isDynamic=1&campaignId=164189&gdpr_consent=&bDim=728x90&ap_DataSignal1=15447664535&ap_DataSignal2=AD1EzRQAAABoCmAKDAgAFQAAAAAdAAAAABIMCAAVAAAAAB0AAAAAIhMIl8-CxjmoAqf17JgCsALRyo4MQCbSAioYACITCNKj74611vkCFVjEhgod4XEPJSgBMAE41uqV760QQAJIAViBgSAQxdbtzgHPTF7MGFqKkFKTvbBt0fLt&c_dv360_sourceurl=https://www.nba.com/stats/teams/advanced/?sort=w&dir=-1&jvxVer=2&gdpr=0&bUnitId=1800&r=1661032730448338&cMacro=https://googleads.g.doubleclick.net/dbm/clk%3Fsa%3DL%26ai%3DC6WmcGlkBY9KuG9iImwTh472oAtvV1fpq1uqV760Q343l0bIoEAEgg_3mH2DJ3uiGyKOQGaAB5ff87QHIAQmoAwHIA5sEqgTnAU_Qm5FE6kEY0vQXE8ibfSODOKqfW_eB2vf1u1zJVY0hludYZ-MNxaebFYOdSh43wo6yAsvjXpPk63C563ffJMdlf9VokSNs47JL8ERX9ULD-uzr2GpdxDJUr9gHRKKnKyBi98KQBIq4uIXWS2NNiO5gQRIQwwMxhqJ49PZExgWJy_9X0fetuhrPgU1vc9pylHXMtR-rXrqz6CcpcNSzAUiFW8N_zHDfNr3vQCufC8qXhVBOqg7dTozEio_mN8AYI-ictB_wUrqIxekJz9c-uOCX8ZYyFxMrVaPJRfahQhA4D81ChTTC88AEsvap89MD4AQDkAYBoAZNgAeDiIOSAqgHjs4bqAeT2BuoB-6WsQKoB_6esQKoB6SjsQKoB9XJG6gHpr4bqAeaBqgH89EbqAeW2BuoB6qbsQKoB9-fsQLYBwDSCA8IgGEQARgfMgKKAjoCgEDyCBpiaWRkZXItdGhlbWVkaWFncmlkX2M2MTBmZYAKBJgLAcgLAYAMAbATi9ndD9ATANgTDYgUAdgUAdAVAfgWAYAXAQ%26ae%3D1%26num%3D1%26cid%3DCAASEuRoWOOjJlLCkwq1FEYh-iOa-w%26sig%3DAOD64_3CsYBi9FAnoDlg108SwtL8lWS-qA%26client%3Dca-pub-7350897138099958%26dbm_c%3DAKAmf-DsbncvGixzVBQCdNPHruC7rlfo6MFXtQwsJiW21_-xj4ET24kSlLoq-J2lLcWDN1wtlM32PczUr1MI-iurbXUIRUrg6ysttRCgQY2RT4AlS0zM2iDq08bAPwgVahA2PGHPXtKsNsgxW-kTTHeTxquqDPCT8g%26cry%3D1%26dbm_d%3DAKAmf-AVLlZmLtIR4-KIsVUz-VYQuKcZi2fs-jkSa4WRgs8z1rjhAqlF9764boHvx9OZXGW9areKGxnav7UOiY4A8BoKLjERPC4KF6tdT7UkaLKvl5KSe73teFnKlgTVZs8wsE_suX8zWjXWyLsf1sV-Qej6T7z_DWWokpF9cX_pQU9NyEIYpmcc06MFbNZVzAwZWVSTPZs1FTSfIURvHvfpDgAJML4gaTaSUG8XiSIwBga1j427LQjOGKj8nyxjzSLwr0RhuK-I3pwhzbKwrK4kloyKBJs48zzWtVaCyRPzUak4I0Pfv-XCFw1bX8H1RPx8Brc9suMCuovSGc8cgARCjRmB2fL86LYyGCVR8kuEyUO4UZ0HD0E8A8XKmOSOHsAQeyIZe-yBX64qYKgFe3HRHFPtaktZRltr3PwSZ50dTkB2EenZxaKeHzL4_G4FYI_1jF2ykKWiKjO_Btlr0buFG-1XI3Bk8LJftupg8x_TGm044p1chNRywkxtEKCU_HIaKMlFslKOdrgazHcrH3w_cOiy9qNrWQ%26adurl%3D&us_privacy=&ts_pId=1cdb39e&siteId=662c3041de43b9&creativeUnitType=18") != -1){
                    cScrNode = scrNodes[i];
                }
            }
        }   
...
function createiFrameNode(obj){
	...
	if(document.body == null){
		document.write("<div id='jvxSkeletonRef_630166f71b873' style='display:none;'></div>")
	}
/*
JavaScript responsible for frame busting
*/
var jvx_630166f71b873TraffickedInFrame = false,			// COM: should be true, if !busted and self != top
	jvx_630166f71b873SafeFrameSupported = false,		// COM: should be true only when safeFrame is supported in the page
	jvx_630166f71b873CanBustFromFrame = true,			// COM: should be false, when all busting method fails
	jvx_630166f71b873InNestedFrame = false;				// COM: should be true, when tag trafficked inside nested frame

if(self != top){
	jvx_630166f71b873TraffickedInFrame = true;
}

try{
		$sf.ext.register(728, 90);
		jvx_630166f71b873SafeFrameSupported = true;
}catch(e){
	jvx_630166f71b873SafeFrameSupported = false;
}
...
var adChoicesCSS = '#jvx_adchoices_630166f71b873 span{background:rgba(204,204,204,0) url("https://playercdn.jivox.com/1651821427/player/images/adchoices.png") no-repeat scroll 0px 0px; padding:0; max-width:75px; width:17px; display:block; text-indent:-9999px; text-align:left; height:15px; cursor:pointer; border-radius:0 0 8px 0;}';
//no-repeat scroll 1px 1px
adChoicesCSS += '#jvx_adchoices_630166f71b873 span:hover {background:rgba(204,204,204,0) url("https://playercdn.jivox.com/1651821427/player/images/adchoices.png") no-repeat scroll 0px 0px; padding:0; max-width:75px; width:75px; display:block; text-indent:-9999px; text-align:left; height:15px; cursor:pointer; border-radius:0 0 8px 0;}';
if(typeof(head) != 'undefined') {
 var head = document.head || document.getElementsByTagName('head')[0];
}
acStyle = document.createElement('style');
acStyle.type = 'text/css';
if (acStyle.styleSheet){
  acStyle.styleSheet.cssText = adChoicesCSS;
} else {
  acStyle.appendChild(document.createTextNode(adChoicesCSS));
}
head.appendChild(acStyle);
...
var adViewabilityDetectInit = function (visibilityThreshold) { 
    try {
        ...
        boxElement = document.querySelector('#adUnitContainer_630166f71b873');
                    ...
                    if (!adInVPForOneSec && !timerRunning) {
                        ...
                        timeoutHandle = setTimeout(function () {
                            adInVPForOneSec = true;
                                                        if(typeof jvx_630166f71b873 != "undefined")
                            jvx_630166f71b873.recordEvent(73);
                            else 
                            recordEvent(73);
                                                    }, 1000);
                    }
...
var CreativeUnit = (function(){
	...
	function receiveHtml5Message(e){
        ...
        var s = e.data.split(':', 10);
		        if(s && s.length >= 2 && s[0] == 'jvx_630166f71b873'){
			var msg = s[1];
			if(msg == 'openExpansion'){
									jvx_630166f71b873.openClickThrough();
							} else if(msg == 'closeExpansion'){
				jvx_630166f71b873.closeExpansion(false, false);
			} else if(msg == 'expansionLoaded'){
							} else if(msg == 'recordUIR'){
				jvx_630166f71b873.UIRRecorded = true;
			} else if(msg == 'lastMouseLeave'){
				jvx_630166f71b873.lastMLeaveId = s[2];
			} else if(msg == 'clearUIR'){
				clearTimeout(jvx_630166f71b873.UIRTimer);
			} else if(msg == 'recordDwell'){
				if(!jvx_630166f71b873.DwellRecorded){
					jvx_630166f71b873.recordDwellEvent(49, jvx_630166f71b873.DwellElapsedTime);
				}
			} 
												else if(msg=="dynamicProperties") {
                jvx_630166f71b873.updateDYProperties(s[2],1);
							}
			else if(msg=="clickThroughUrl") { 
								jvx_630166f71b873.clickTagURL = s.slice(2).flat(1).join(":");
			}
			else if(msg == "clickTrackers") {	
								jvx_630166f71b873.clickTrackers =  s.slice(2).join(":").split(",").map(function(url){ return decodeURIComponent(url) });
				this.clickTrackers = jvx_630166f71b873.clickTrackers;
			}
												                        else if(msg == "miniScrollerBgInfo"){
                var miniScrollerBgURL = decodeURIComponent(s[2]);
                jvx_630166f71b873.fixedBgAstLeft = parseInt(s[3]);
                jvx_630166f71b873.renderFixedPageBg(miniScrollerBgURL,s[3]);
            } 
		}
	}
	...
	function postHtml5Message(winRef, msg){
		try{
			winRef.postMessage('jvx_630166f71b873' + ':' + msg, "*");
		}catch(e){
			if(typeof(winRef.contentWindow) != 'undefined')
				winRef.contentWindow.postMessage('jvx_630166f71b873' + ':' + msg, "*");
		}
	}
	...
	*/
	...
	function clearNode(pNode, idPrefix){
        ...
        if(jvx_630166f71b873TraffickedInFrame){
                        try{
...
finalURL = replaceCacheBuster4;			//finalURL = replaceCacheBuster;
			...
			if(url.indexOf("?") == -1){
				...
				finalURL = url + "&r=" + Math.random();
					...
					if(typeof jvx_630166f71b873 != 'undefined' && url.match("http://evs.jivox.com/jivox/serverAPIs/saveImpression.php")){	//Add es_cgName and es_segName params only for the evs trackers URL not for the thirdParty trackers.
				finalURL += "&es_cgName_"+jvx_630166f71b873.DYReportingKey;
                if(jvx_630166f71b873.DYSegmentName != ""){
                    finalURL += "&es_segName_"+jvx_630166f71b873.DYSegmentName;
                }
			}
				imgEl.src = finalURL;
			}       
	...
	function setOpacity(myElement, opacityValue) {
		...
		var cLeft = sfLeft + "px",
			cTop = sfTop + "px",
			cNode = getElById(jvx_630166f71b873.adUnitContainerId);
		addStyles(cNode, {"left":cLeft, "top":cTop});
	}
	function renderAdInsideSafeFrame(animDir){
		if(jvx_630166f71b873SafeFrameSupported){
			/* ------------- SafeFrame Settings--------------- */
						var ref = jvx_630166f71b873,
	 ...
	 /* var rect = obj.getBoundingClientRect();
		...
		var vpStyles = findPos(getElById(jvx_630166f71b873.adUnitContainerId)),
			vpTop = "", vpLeft = "";
	...
	function mraidHandleOnViewable(viewable){
		jvxMraidIsShown = viewable;		 
			if(!jvxMraidIsShown || getElById(jvx_630166f71b873.baseContainerId)){
				return; 
			}
		jvx_630166f71b873.init();
	...
	function handleMraidViewableImprFiring(){
		if (!adInVPForOneSec && !timerRunning) {
			...
			var timeoutHandle = setTimeout(function () {
				adInVPForOneSec = true;
				jvx_630166f71b873.recordEvent(74);
			}, 1000);
		}
	}
	...
	function CreativeUnit(uniqId){
	    ...
	    this.id = uniqId;  
		this.playerParamsMap = {"reportingURL":"https:\/\/evs.jivox.com","es_pId":"1cdb39e","showAdChoices":"1","isDynamic":"1","campaignId":"164189","gdpr_consent":"","bDim":"728x90","ap_DataSignal1":"15447664535","ap_DataSignal2":"AD1EzRQAAABoCmAKDAgAFQAAAAAdAAAAABIMCAAVAAAAAB0AAAAAIhMIl8-CxjmoAqf17JgCsALRyo4MQCbSAioYACITCNKj74611vkCFVjEhgod4XEPJSgBMAE41uqV760QQAJIAViBgSAQxdbtzgHPTF7MGFqKkFKTvbBt0fLt","c_dv360_sourceurl":"https:\/\/www.nba.com\/stats\/teams\/advanced\/?sort=w","dir":"-1","jvxVer":"2","gdpr":"0","bUnitId":"1800","r":"1661032730448338","cMacro":"https:\/\/googleads.g.doubleclick.net\/dbm\/clk?sa=L&ai=C6WmcGlkBY9KuG9iImwTh472oAtvV1fpq1uqV760Q343l0bIoEAEgg_3mH2DJ3uiGyKOQGaAB5ff87QHIAQmoAwHIA5sEqgTnAU_Qm5FE6kEY0vQXE8ibfSODOKqfW_eB2vf1u1zJVY0hludYZ-MNxaebFYOdSh43wo6yAsvjXpPk63C563ffJMdlf9VokSNs47JL8ERX9ULD-uzr2GpdxDJUr9gHRKKnKyBi98KQBIq4uIXWS2NNiO5gQRIQwwMxhqJ49PZExgWJy_9X0fetuhrPgU1vc9pylHXMtR-rXrqz6CcpcNSzAUiFW8N_zHDfNr3vQCufC8qXhVBOqg7dTozEio_mN8AYI-ictB_wUrqIxekJz9c-uOCX8ZYyFxMrVaPJRfahQhA4D81ChTTC88AEsvap89MD4AQDkAYBoAZNgAeDiIOSAqgHjs4bqAeT2BuoB-6WsQKoB_6esQKoB6SjsQKoB9XJG6gHpr4bqAeaBqgH89EbqAeW2BuoB6qbsQKoB9-fsQLYBwDSCA8IgGEQARgfMgKKAjoCgEDyCBpiaWRkZXItdGhlbWVkaWFncmlkX2M2MTBmZYAKBJgLAcgLAYAMAbATi9ndD9ATANgTDYgUAdgUAdAVAfgWAYAXAQ&ae=1&num=1&cid=CAASEuRoWOOjJlLCkwq1FEYh-iOa-w&sig=AOD64_3CsYBi9FAnoDlg108SwtL8lWS-qA&client=ca-pub-7350897138099958&dbm_c=AKAmf-DsbncvGixzVBQCdNPHruC7rlfo6MFXtQwsJiW21_-xj4ET24kSlLoq-J2lLcWDN1wtlM32PczUr1MI-iurbXUIRUrg6ysttRCgQY2RT4AlS0zM2iDq08bAPwgVahA2PGHPXtKsNsgxW-kTTHeTxquqDPCT8g&cry=1&dbm_d=AKAmf-AVLlZmLtIR4-KIsVUz-VYQuKcZi2fs-jkSa4WRgs8z1rjhAqlF9764boHvx9OZXGW9areKGxnav7UOiY4A8BoKLjERPC4KF6tdT7UkaLKvl5KSe73teFnKlgTVZs8wsE_suX8zWjXWyLsf1sV-Qej6T7z_DWWokpF9cX_pQU9NyEIYpmcc06MFbNZVzAwZWVSTPZs1FTSfIURvHvfpDgAJML4gaTaSUG8XiSIwBga1j427LQjOGKj8nyxjzSLwr0RhuK-I3pwhzbKwrK4kloyKBJs48zzWtVaCyRPzUak4I0Pfv-XCFw1bX8H1RPx8Brc9suMCuovSGc8cgARCjRmB2fL86LYyGCVR8kuEyUO4UZ0HD0E8A8XKmOSOHsAQeyIZe-yBX64qYKgFe3HRHFPtaktZRltr3PwSZ50dTkB2EenZxaKeHzL4_G4FYI_1jF2ykKWiKjO_Btlr0buFG-1XI3Bk8LJftupg8x_TGm044p1chNRywkxtEKCU_HIaKMlFslKOdrgazHcrH3w_cOiy9qNrWQ&adurl=","us_privacy":"","ts_pId":"1cdb39e","siteId":"662c3041de43b9","creativeUnitType":"18","0":"","serverURL":"https:\/\/as.jivox.com"};
		this.campaignId = '164189';
		this.siteId = '662c3041de43b9';
		this.placementId = '1cdb39e';
		...
		this.browserVersion = '104.0.0.0';
								this.clickTagURL = 'https://googleads.g.doubleclick.net/dbm/clk?sa=L&ai=C6WmcGlkBY9KuG9iImwTh472oAtvV1fpq1uqV760Q343l0bIoEAEgg_3mH2DJ3uiGyKOQGaAB5ff87QHIAQmoAwHIA5sEqgTnAU_Qm5FE6kEY0vQXE8ibfSODOKqfW_eB2vf1u1zJVY0hludYZ-MNxaebFYOdSh43wo6yAsvjXpPk63C563ffJMdlf9VokSNs47JL8ERX9ULD-uzr2GpdxDJUr9gHRKKnKyBi98KQBIq4uIXWS2NNiO5gQRIQwwMxhqJ49PZExgWJy_9X0fetuhrPgU1vc9pylHXMtR-rXrqz6CcpcNSzAUiFW8N_zHDfNr3vQCufC8qXhVBOqg7dTozEio_mN8AYI-ictB_wUrqIxekJz9c-uOCX8ZYyFxMrVaPJRfahQhA4D81ChTTC88AEsvap89MD4AQDkAYBoAZNgAeDiIOSAqgHjs4bqAeT2BuoB-6WsQKoB_6esQKoB6SjsQKoB9XJG6gHpr4bqAeaBqgH89EbqAeW2BuoB6qbsQKoB9-fsQLYBwDSCA8IgGEQARgfMgKKAjoCgEDyCBpiaWRkZXItdGhlbWVkaWFncmlkX2M2MTBmZYAKBJgLAcgLAYAMAbATi9ndD9ATANgTDYgUAdgUAdAVAfgWAYAXAQ&ae=1&num=1&cid=CAASEuRoWOOjJlLCkwq1FEYh-iOa-w&sig=AOD64_3CsYBi9FAnoDlg108SwtL8lWS-qA&client=ca-pub-7350897138099958&dbm_c=AKAmf-DsbncvGixzVBQCdNPHruC7rlfo6MFXtQwsJiW21_-xj4ET24kSlLoq-J2lLcWDN1wtlM32PczUr1MI-iurbXUIRUrg6ysttRCgQY2RT4AlS0zM2iDq08bAPwgVahA2PGHPXtKsNsgxW-kTTHeTxquqDPCT8g&cry=1&dbm_d=AKAmf-AVLlZmLtIR4-KIsVUz-VYQuKcZi2fs-jkSa4WRgs8z1rjhAqlF9764boHvx9OZXGW9areKGxnav7UOiY4A8BoKLjERPC4KF6tdT7UkaLKvl5KSe73teFnKlgTVZs8wsE_suX8zWjXWyLsf1sV-Qej6T7z_DWWokpF9cX_pQU9NyEIYpmcc06MFbNZVzAwZWVSTPZs1FTSfIURvHvfpDgAJML4gaTaSUG8XiSIwBga1j427LQjOGKj8nyxjzSLwr0RhuK-I3pwhzbKwrK4kloyKBJs48zzWtVaCyRPzUak4I0Pfv-XCFw1bX8H1RPx8Brc9suMCuovSGc8cgARCjRmB2fL86LYyGCVR8kuEyUO4UZ0HD0E8A8XKmOSOHsAQeyIZe-yBX64qYKgFe3HRHFPtaktZRltr3PwSZ50dTkB2EenZxaKeHzL4_G4FYI_1jF2ykKWiKjO_Btlr0buFG-1XI3Bk8LJftupg8x_TGm044p1chNRywkxtEKCU_HIaKMlFslKOdrgazHcrH3w_cOiy9qNrWQ&adurl=https%3A%2F%2Fwww.t-mobile.com%2F';
		this.clickTrackers = [];
		...
		this.baseURL = 'https://as.jivox.com/unit/layout_renderer.php?es_pId=1cdb39e&showAdChoices=1&isDynamic=1&campaignId=164189&gdpr_consent=&bDim=728x90&ap_DataSignal1=15447664535&ap_DataSignal2=AD1EzRQAAABoCmAKDAgAFQAAAAAdAAAAABIMCAAVAAAAAB0AAAAAIhMIl8-CxjmoAqf17JgCsALRyo4MQCbSAioYACITCNKj74611vkCFVjEhgod4XEPJSgBMAE41uqV760QQAJIAViBgSAQxdbtzgHPTF7MGFqKkFKTvbBt0fLt&c_dv360_sourceurl=https%3A%2F%2Fwww.nba.com%2Fstats%2Fteams%2Fadvanced%2F%3Fsort%3Dw&dir=-1&jvxVer=2&gdpr=0&bUnitId=1800&r=1661032730448338&cMacro=https%3A%2F%2Fgoogleads.g.doubleclick.net%2Fdbm%2Fclk%3Fsa%3DL%26ai%3DC6WmcGlkBY9KuG9iImwTh472oAtvV1fpq1uqV760Q343l0bIoEAEgg_3mH2DJ3uiGyKOQGaAB5ff87QHIAQmoAwHIA5sEqgTnAU_Qm5FE6kEY0vQXE8ibfSODOKqfW_eB2vf1u1zJVY0hludYZ-MNxaebFYOdSh43wo6yAsvjXpPk63C563ffJMdlf9VokSNs47JL8ERX9ULD-uzr2GpdxDJUr9gHRKKnKyBi98KQBIq4uIXWS2NNiO5gQRIQwwMxhqJ49PZExgWJy_9X0fetuhrPgU1vc9pylHXMtR-rXrqz6CcpcNSzAUiFW8N_zHDfNr3vQCufC8qXhVBOqg7dTozEio_mN8AYI-ictB_wUrqIxekJz9c-uOCX8ZYyFxMrVaPJRfahQhA4D81ChTTC88AEsvap89MD4AQDkAYBoAZNgAeDiIOSAqgHjs4bqAeT2BuoB-6WsQKoB_6esQKoB6SjsQKoB9XJG6gHpr4bqAeaBqgH89EbqAeW2BuoB6qbsQKoB9-fsQLYBwDSCA8IgGEQARgfMgKKAjoCgEDyCBpiaWRkZXItdGhlbWVkaWFncmlkX2M2MTBmZYAKBJgLAcgLAYAMAbATi9ndD9ATANgTDYgUAdgUAdAVAfgWAYAXAQ%26ae%3D1%26num%3D1%26cid%3DCAASEuRoWOOjJlLCkwq1FEYh-iOa-w%26sig%3DAOD64_3CsYBi9FAnoDlg108SwtL8lWS-qA%26client%3Dca-pub-7350897138099958%26dbm_c%3DAKAmf-DsbncvGixzVBQCdNPHruC7rlfo6MFXtQwsJiW21_-xj4ET24kSlLoq-J2lLcWDN1wtlM32PczUr1MI-iurbXUIRUrg6ysttRCgQY2RT4AlS0zM2iDq08bAPwgVahA2PGHPXtKsNsgxW-kTTHeTxquqDPCT8g%26cry%3D1%26dbm_d%3DAKAmf-AVLlZmLtIR4-KIsVUz-VYQuKcZi2fs-jkSa4WRgs8z1rjhAqlF9764boHvx9OZXGW9areKGxnav7UOiY4A8BoKLjERPC4KF6tdT7UkaLKvl5KSe73teFnKlgTVZs8wsE_suX8zWjXWyLsf1sV-Qej6T7z_DWWokpF9cX_pQU9NyEIYpmcc06MFbNZVzAwZWVSTPZs1FTSfIURvHvfpDgAJML4gaTaSUG8XiSIwBga1j427LQjOGKj8nyxjzSLwr0RhuK-I3pwhzbKwrK4kloyKBJs48zzWtVaCyRPzUak4I0Pfv-XCFw1bX8H1RPx8Brc9suMCuovSGc8cgARCjRmB2fL86LYyGCVR8kuEyUO4UZ0HD0E8A8XKmOSOHsAQeyIZe-yBX64qYKgFe3HRHFPtaktZRltr3PwSZ50dTkB2EenZxaKeHzL4_G4FYI_1jF2ykKWiKjO_Btlr0buFG-1XI3Bk8LJftupg8x_TGm044p1chNRywkxtEKCU_HIaKMlFslKOdrgazHcrH3w_cOiy9qNrWQ%26adurl%3D&us_privacy=&ts_pId=1cdb39e&siteId=662c3041de43b9&creativeUnitType=18&objectName=jvx_630166f71b873&adUnitId=1800&jvxSessionId=1661036279.7947';
        			this.baseURL += '&base=1';
	...
	CreativeUnit.prototype = {
		constructor:CreativeUnit,
         ...
         sendCookieRequest: function(cookieName){
	        if(jvx_630166f71b873SafeFrameSupported){
		         var callBackFnName ='jvx_630166f71b873'+".updateDYProperties";
		         jvx_630166f71b873.addScriptTagToBody('https://as.jivox.com'+"/unit/getCookies.php?cookieName="+cookieName+"&callback="+callBackFnName+"&deleteCookie="+1+"&r_="+Math.random());  
	         }                  
         },
         updateDYProperties: function(val,isNotCookieData){
            ...
            jvx_630166f71b873.DYReportingKey = dynPropArr[0] ? decodeURIComponent(dynPropArr[0]) : "";
            jvx_630166f71b873.DYSegmentName = dynPropArr[1] ? decodeURIComponent(dynPropArr[1]) : "";
			jvx_630166f71b873.eventServerParams = dynPropArr[2] ? decodeURIComponent(dynPropArr[2]) : "";   //Getting trafficker events output from layout_renderer_html.php
            //this.fireCREvent();
			jvx_630166f71b873dyPropsACK = true;
         },
			...
			if(doFireCreativeLoadEvt){
				...
				jvx_630166f71b873.recordEvent(72, 'es_et=' + creativeLoadElapseTime);
			}
		},
                    ...
                    if(jvx_630166f71b873SafeFrameSupported){
                        var getReportingKeyFromCookie = false,
                            ...
                            if(getReportingKeyFromCookie){
                                jvx_630166f71b873.sendCookieRequest('jvx_630166f71b873'+"_dynamicProperties");
                            }
                    }
                											}	
		},
			...
			var executeCallBack = function(transitionEvt){
					...
					if(ref.expansionOpen){
						...
						if(ref.openExpAgain) ref.openExpAgain = false; 
												...
												if(jvx_630166f71b873SafeFrameSupported && transitionEvt){
							try{
								$sf.ext.collapse();
															}catch(e){}
						}
		...
		getIBusterFrameInfo:function(){
			if(typeof(jivoxIBusterAdObject) != "undefined"){
				...
				for(var i=0; i < iFramesLen; i++){
					if(hostIframes[i].contentWindow == jivoxIBusterAdObject["jvx_630166f71b873"].foreignWindow){
...
//				e2Node.style.margin = mt + ' 0 0 ' + ml;
		...
		openWindow:function(url){
							if(jvx_630166f71b873NonMraidTagInMraidEnv){
					mraid.open(url);
				} else {
					window.open(url);
				}
		...
		openClickThrough:function(){
				...
				openExpansion:function(autoExpand, skipOpenEvent){
						...
						if(!jvx_630166f71b873CanBustFromFrame || jvx_630166f71b873InNestedFrame){
				return;
			}
		...
		recordEvent:function(eventId,addnlParams){
											if( !jvx_630166f71b873dyPropsACK && (eventId==48 || eventId==49 || eventId==1)){
					addnlParams = (addnlParams) ? addnlParams + "/c_actualEventId="+eventId : "c_actualEventId="+eventId;
					eventId = 78;
				}
								var eventReportingParams = '';
											eventReportingParams = "210409/1800/164189/662c3041de43b9/18/jvxSId_1661036279.7947";		
												var rand = Math.random();
				var imgEl = document.createElement("img");
                var tempURL = "";
                var eventReportingURL = "https://evs.jivox.com/trk" + "/" + eventId + "/" + eventReportingParams;
                eventReportingURL += "/es_pId_1cdb39e";
                tempURL += "";
                                tempURL += "/ap_DataSignal1=15447664535/ap_DataSignal2=AD1EzRQAAABoCmAKDAgAFQAAAAAdAAAAABIMCAAVAAAAAB0AAAAAIhMIl8-CxjmoAqf17JgCsALRyo4MQCbSAioYACITCNKj74611vkCFVjEhgod4XEPJSgBMAE41uqV760QQAJIAViBgSAQxdbtzgHPTF7MGFqKkFKTvbBt0fLt";
                									if(jvx_630166f71b873.eventServerParams != "" && jvx_630166f71b873.eventServerParams != undefined){
						tempURL += "/" + jvx_630166f71b873.eventServerParams;
					}
				                tempURL = addnlParams ? (tempURL + "/" + addnlParams) : tempURL;
									tempURL += "/bDim="+ "728x90";
								tempURL = tempURL + "/jvxRandom=" + rand;
				//eventReportingURL = (eventId == 1) ? (eventReportingURL + ";https://googleads.g.doubleclick.net/dbm/clk?sa=L&ai=C6WmcGlkBY9KuG9iImwTh472oAtvV1fpq1uqV760Q343l0bIoEAEgg_3mH2DJ3uiGyKOQGaAB5ff87QHIAQmoAwHIA5sEqgTnAU_Qm5FE6kEY0vQXE8ibfSODOKqfW_eB2vf1u1zJVY0hludYZ-MNxaebFYOdSh43wo6yAsvjXpPk63C563ffJMdlf9VokSNs47JL8ERX9ULD-uzr2GpdxDJUr9gHRKKnKyBi98KQBIq4uIXWS2NNiO5gQRIQwwMxhqJ49PZExgWJy_9X0fetuhrPgU1vc9pylHXMtR-rXrqz6CcpcNSzAUiFW8N_zHDfNr3vQCufC8qXhVBOqg7dTozEio_mN8AYI-ictB_wUrqIxekJz9c-uOCX8ZYyFxMrVaPJRfahQhA4D81ChTTC88AEsvap89MD4AQDkAYBoAZNgAeDiIOSAqgHjs4bqAeT2BuoB-6WsQKoB_6esQKoB6SjsQKoB9XJG6gHpr4bqAeaBqgH89EbqAeW2BuoB6qbsQKoB9-fsQLYBwDSCA8IgGEQARgfMgKKAjoCgEDyCBpiaWRkZXItdGhlbWVkaWFncmlkX2M2MTBmZYAKBJgLAcgLAYAMAbATi9ndD9ATANgTDYgUAdgUAdAVAfgWAYAXAQ&ae=1&num=1&cid=CAASEuRoWOOjJlLCkwq1FEYh-iOa-w&sig=AOD64_3CsYBi9FAnoDlg108SwtL8lWS-qA&client=ca-pub-7350897138099958&dbm_c=AKAmf-DsbncvGixzVBQCdNPHruC7rlfo6MFXtQwsJiW21_-xj4ET24kSlLoq-J2lLcWDN1wtlM32PczUr1MI-iurbXUIRUrg6ysttRCgQY2RT4AlS0zM2iDq08bAPwgVahA2PGHPXtKsNsgxW-kTTHeTxquqDPCT8g&cry=1&dbm_d=AKAmf-AVLlZmLtIR4-KIsVUz-VYQuKcZi2fs-jkSa4WRgs8z1rjhAqlF9764boHvx9OZXGW9areKGxnav7UOiY4A8BoKLjERPC4KF6tdT7UkaLKvl5KSe73teFnKlgTVZs8wsE_suX8zWjXWyLsf1sV-Qej6T7z_DWWokpF9cX_pQU9NyEIYpmcc06MFbNZVzAwZWVSTPZs1FTSfIURvHvfpDgAJML4gaTaSUG8XiSIwBga1j427LQjOGKj8nyxjzSLwr0RhuK-I3pwhzbKwrK4kloyKBJs48zzWtVaCyRPzUak4I0Pfv-XCFw1bX8H1RPx8Brc9suMCuovSGc8cgARCjRmB2fL86LYyGCVR8kuEyUO4UZ0HD0E8A8XKmOSOHsAQeyIZe-yBX64qYKgFe3HRHFPtaktZRltr3PwSZ50dTkB2EenZxaKeHzL4_G4FYI_1jF2ykKWiKjO_Btlr0buFG-1XI3Bk8LJftupg8x_TGm044p1chNRywkxtEKCU_HIaKMlFslKOdrgazHcrH3w_cOiy9qNrWQ&adurl=https%3A%2F%2Fwww.t-mobile.com%2F") : eventReportingURL;
									tempURL += "/es_cgName="+jvx_630166f71b873.DYReportingKey;
                    if(jvx_630166f71b873.DYSegmentName != ""){
                        tempURL += "/es_segName="+jvx_630166f71b873.DYSegmentName;
                    }
		...
		recordDwellEvent:function(eventId, elapsedTime){
			...
			this.DwellTimer = null;
						...
						var cNode = createDivNode(this.adUnitContainerId);
			            												document.write('<div id="jvxScrRefNode_630166f71b873" style="display:none;"></div>');	
				var jvxPNode = '';
				var jvxNode = getElById("jvxScrRefNode_630166f71b873");
            ...
            return pNode;
				...
				renderAdChoices:function(){
			//AdChoices Div
						var bcNode = getElById(this.baseContainerId);
						var aNode = createDivNode('jvx_adchoices'+this.id);
			bcNode.appendChild(aNode);
			
			//Set style to ad choices div
			var divStyleObj = {position:'absolute', top: '0px', left:'0px'};
			addStyles(aNode, divStyleObj);

			//AdChoices image with anchor
			var anchor = document.createElement('a');
			anchor.href = 'https://www.jivox.com/privacypolicy.php#targetInfo';
			anchor.target = '_blank';
			aNode.appendChild(anchor);
			var spanEl = document.createElement('span');
			spanEl.innerHTML = 'Privacy';
			...
			if(bestFitBase) {
				...
				if(this.baseHasLayout == 1) {
					this.baseType = 'html';
					this.baseURL = 'https://as.jivox.com/unit/layout_renderer.php?es_pId=1cdb39e&showAdChoices=1&isDynamic=1&campaignId=164189&gdpr_consent=&bDim=728x90&ap_DataSignal1=15447664535&ap_DataSignal2=AD1EzRQAAABoCmAKDAgAFQAAAAAdAAAAABIMCAAVAAAAAB0AAAAAIhMIl8-CxjmoAqf17JgCsALRyo4MQCbSAioYACITCNKj74611vkCFVjEhgod4XEPJSgBMAE41uqV760QQAJIAViBgSAQxdbtzgHPTF7MGFqKkFKTvbBt0fLt&c_dv360_sourceurl=https%3A%2F%2Fwww.nba.com%2Fstats%2Fteams%2Fadvanced%2F%3Fsort%3Dw&dir=-1&jvxVer=2&gdpr=0&bUnitId=1800&r=1661032730448338&cMacro=https%3A%2F%2Fgoogleads.g.doubleclick.net%2Fdbm%2Fclk%3Fsa%3DL%26ai%3DC6WmcGlkBY9KuG9iImwTh472oAtvV1fpq1uqV760Q343l0bIoEAEgg_3mH2DJ3uiGyKOQGaAB5ff87QHIAQmoAwHIA5sEqgTnAU_Qm5FE6kEY0vQXE8ibfSODOKqfW_eB2vf1u1zJVY0hludYZ-MNxaebFYOdSh43wo6yAsvjXpPk63C563ffJMdlf9VokSNs47JL8ERX9ULD-uzr2GpdxDJUr9gHRKKnKyBi98KQBIq4uIXWS2NNiO5gQRIQwwMxhqJ49PZExgWJy_9X0fetuhrPgU1vc9pylHXMtR-rXrqz6CcpcNSzAUiFW8N_zHDfNr3vQCufC8qXhVBOqg7dTozEio_mN8AYI-ictB_wUrqIxekJz9c-uOCX8ZYyFxMrVaPJRfahQhA4D81ChTTC88AEsvap89MD4AQDkAYBoAZNgAeDiIOSAqgHjs4bqAeT2BuoB-6WsQKoB_6esQKoB6SjsQKoB9XJG6gHpr4bqAeaBqgH89EbqAeW2BuoB6qbsQKoB9-fsQLYBwDSCA8IgGEQARgfMgKKAjoCgEDyCBpiaWRkZXItdGhlbWVkaWFncmlkX2M2MTBmZYAKBJgLAcgLAYAMAbATi9ndD9ATANgTDYgUAdgUAdAVAfgWAYAXAQ%26ae%3D1%26num%3D1%26cid%3DCAASEuRoWOOjJlLCkwq1FEYh-iOa-w%26sig%3DAOD64_3CsYBi9FAnoDlg108SwtL8lWS-qA%26client%3Dca-pub-7350897138099958%26dbm_c%3DAKAmf-DsbncvGixzVBQCdNPHruC7rlfo6MFXtQwsJiW21_-xj4ET24kSlLoq-J2lLcWDN1wtlM32PczUr1MI-iurbXUIRUrg6ysttRCgQY2RT4AlS0zM2iDq08bAPwgVahA2PGHPXtKsNsgxW-kTTHeTxquqDPCT8g%26cry%3D1%26dbm_d%3DAKAmf-AVLlZmLtIR4-KIsVUz-VYQuKcZi2fs-jkSa4WRgs8z1rjhAqlF9764boHvx9OZXGW9areKGxnav7UOiY4A8BoKLjERPC4KF6tdT7UkaLKvl5KSe73teFnKlgTVZs8wsE_suX8zWjXWyLsf1sV-Qej6T7z_DWWokpF9cX_pQU9NyEIYpmcc06MFbNZVzAwZWVSTPZs1FTSfIURvHvfpDgAJML4gaTaSUG8XiSIwBga1j427LQjOGKj8nyxjzSLwr0RhuK-I3pwhzbKwrK4kloyKBJs48zzWtVaCyRPzUak4I0Pfv-XCFw1bX8H1RPx8Brc9suMCuovSGc8cgARCjRmB2fL86LYyGCVR8kuEyUO4UZ0HD0E8A8XKmOSOHsAQeyIZe-yBX64qYKgFe3HRHFPtaktZRltr3PwSZ50dTkB2EenZxaKeHzL4_G4FYI_1jF2ykKWiKjO_Btlr0buFG-1XI3Bk8LJftupg8x_TGm044p1chNRywkxtEKCU_HIaKMlFslKOdrgazHcrH3w_cOiy9qNrWQ%26adurl%3D&us_privacy=&ts_pId=1cdb39e&siteId=662c3041de43b9&creativeUnitType=18&objectName=jvx_630166f71b873';
											this.baseURL += '&jvxSessionId=1661036279.7947';
			...
			if(bestFitExpand) {
				...
				if(this.expansionHasLayout == 1) {
					this.expansionType = 'html';
										var adUnitIdStr = '';
										this.expansionURL = 'https://as.jivox.com/unit/layout_renderer.php?es_pId=1cdb39e&showAdChoices=1&isDynamic=1&campaignId=164189&gdpr_consent=&bDim=728x90&ap_DataSignal1=15447664535&ap_DataSignal2=AD1EzRQAAABoCmAKDAgAFQAAAAAdAAAAABIMCAAVAAAAAB0AAAAAIhMIl8-CxjmoAqf17JgCsALRyo4MQCbSAioYACITCNKj74611vkCFVjEhgod4XEPJSgBMAE41uqV760QQAJIAViBgSAQxdbtzgHPTF7MGFqKkFKTvbBt0fLt&c_dv360_sourceurl=https%3A%2F%2Fwww.nba.com%2Fstats%2Fteams%2Fadvanced%2F%3Fsort%3Dw&dir=-1&jvxVer=2&gdpr=0&&r=1661032730448338&cMacro=https%3A%2F%2Fgoogleads.g.doubleclick.net%2Fdbm%2Fclk%3Fsa%3DL%26ai%3DC6WmcGlkBY9KuG9iImwTh472oAtvV1fpq1uqV760Q343l0bIoEAEgg_3mH2DJ3uiGyKOQGaAB5ff87QHIAQmoAwHIA5sEqgTnAU_Qm5FE6kEY0vQXE8ibfSODOKqfW_eB2vf1u1zJVY0hludYZ-MNxaebFYOdSh43wo6yAsvjXpPk63C563ffJMdlf9VokSNs47JL8ERX9ULD-uzr2GpdxDJUr9gHRKKnKyBi98KQBIq4uIXWS2NNiO5gQRIQwwMxhqJ49PZExgWJy_9X0fetuhrPgU1vc9pylHXMtR-rXrqz6CcpcNSzAUiFW8N_zHDfNr3vQCufC8qXhVBOqg7dTozEio_mN8AYI-ictB_wUrqIxekJz9c-uOCX8ZYyFxMrVaPJRfahQhA4D81ChTTC88AEsvap89MD4AQDkAYBoAZNgAeDiIOSAqgHjs4bqAeT2BuoB-6WsQKoB_6esQKoB6SjsQKoB9XJG6gHpr4bqAeaBqgH89EbqAeW2BuoB6qbsQKoB9-fsQLYBwDSCA8IgGEQARgfMgKKAjoCgEDyCBpiaWRkZXItdGhlbWVkaWFncmlkX2M2MTBmZYAKBJgLAcgLAYAMAbATi9ndD9ATANgTDYgUAdgUAdAVAfgWAYAXAQ%26ae%3D1%26num%3D1%26cid%3DCAASEuRoWOOjJlLCkwq1FEYh-iOa-w%26sig%3DAOD64_3CsYBi9FAnoDlg108SwtL8lWS-qA%26client%3Dca-pub-7350897138099958%26dbm_c%3DAKAmf-DsbncvGixzVBQCdNPHruC7rlfo6MFXtQwsJiW21_-xj4ET24kSlLoq-J2lLcWDN1wtlM32PczUr1MI-iurbXUIRUrg6ysttRCgQY2RT4AlS0zM2iDq08bAPwgVahA2PGHPXtKsNsgxW-kTTHeTxquqDPCT8g%26cry%3D1%26dbm_d%3DAKAmf-AVLlZmLtIR4-KIsVUz-VYQuKcZi2fs-jkSa4WRgs8z1rjhAqlF9764boHvx9OZXGW9areKGxnav7UOiY4A8BoKLjERPC4KF6tdT7UkaLKvl5KSe73teFnKlgTVZs8wsE_suX8zWjXWyLsf1sV-Qej6T7z_DWWokpF9cX_pQU9NyEIYpmcc06MFbNZVzAwZWVSTPZs1FTSfIURvHvfpDgAJML4gaTaSUG8XiSIwBga1j427LQjOGKj8nyxjzSLwr0RhuK-I3pwhzbKwrK4kloyKBJs48zzWtVaCyRPzUak4I0Pfv-XCFw1bX8H1RPx8Brc9suMCuovSGc8cgARCjRmB2fL86LYyGCVR8kuEyUO4UZ0HD0E8A8XKmOSOHsAQeyIZe-yBX64qYKgFe3HRHFPtaktZRltr3PwSZ50dTkB2EenZxaKeHzL4_G4FYI_1jF2ykKWiKjO_Btlr0buFG-1XI3Bk8LJftupg8x_TGm044p1chNRywkxtEKCU_HIaKMlFslKOdrgazHcrH3w_cOiy9qNrWQ%26adurl%3D&us_privacy=&ts_pId=1cdb39e&siteId=662c3041de43b9&creativeUnitType=18&objectName=jvx_630166f71b873'+adUnitIdStr;
											this.expansionURL += '&jvxSessionId=1661036279.7947';
			...
			if(eventSrc){
				...
				if(eventSrcId == this.baseId || eventSrcId == this.base2Id){
					...
					this.closeBase();
								...
								else if(eventSrc.tagName == "SPAN" && (eventSrc.parentElement.parentElement.id == "jvx_adchoices"+this.id || eventSrc.parentElement.parentElement.id == "jvx_adchoices"+this.id+"0")){
										postHtml5Message(this.getElById(this.baseId), 'clickThroughFromAdChoice');
														}
											}
		},
		...
		delegateEvents:function(){
			...
			addEvent(getElById(this.baseContainerId), "mouseleave", that.listenerCallback, false);
									...
									addEvent(getElById('jvx_adchoices'+this.id), "click", that.listenerCallback, false);
		...
		listenerCallback:function(event) {
			jvx_630166f71b873.eventController(event); 
		},
...
var jvx_630166f71b873 = new CreativeUnit("_630166f71b873");
jvx_630166f71b873.DYReportingKey = "";
jvx_630166f71b873.DYSegmentName = "";
jvx_630166f71b873.eventServerParams = "";
	if(jvx_630166f71b873NonMraidTagInMraidEnv){
				jvx_630166f71b873.recordEvent(75);
	}
    jvx_630166f71b873.init();
